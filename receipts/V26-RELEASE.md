...
- CableBox 2 web edition embedded same-origin: 354 files / 106,465,125 bytes.
...
- GitHub Pages is a static source mirror; the public interactive edition is intentionally served same-origin from `atomeons.com/cablebox/web` so the existing relay accepts its origin.
