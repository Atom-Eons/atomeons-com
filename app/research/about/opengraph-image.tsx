...
export const alt =
  "About ÆoNs Research — the research arm of AtomEons. Solo independent lab. CC-BY 4.0. Twelve manuscripts. Naples.";
    ...
    (
      <div
        style={{
          ...
          background:
            "radial-gradient(60% 55% at 70% 30%, rgba(117,255,196,0.32) 0%, transparent 60%), radial-gradient(50% 45% at 20% 80%, rgba(34,240,213,0.30) 0%, transparent 65%), #08090B",
          color: "#F2F4F5",
          padding: 60,
          fontFamily:
