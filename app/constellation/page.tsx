...
// at last verification (2026-06-18): 319 nodes · 943 edges. If the
...
export const metadata: Metadata = {
  ...
  description:
    "Every public route on atomeons.com rendered as an interactive force-laid graph. 319 nodes · 943 edges. Drag to pan, wheel to zoom, click any node to navigate.",
  alternates: { canonical: "https://atomeons.com/constellation" },
  openGraph: {
    title: "Constellation · the lab as a graph",
    description: "319 routes · 943 edges · interactive · click to navigate",
