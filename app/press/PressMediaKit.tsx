...
const ONE_SENTENCE_PITCH = `AtomEons is an independent AI systems laboratory in Marco Island, Florida — one founder, one $1 desktop AI cockpit (ORANGEBOX Command), twelve peer-ready research papers, a 38-page sci-fi monograph, and a nightly broadcast — all shipped without venture funding while Anthropic raised $30B and OpenAI raised at $500B.`;

const BOILERPLATE_GRAF = `Founded in 2026 by Atom McCree, AtomEons Systems Laboratory is an independent AI research and product lab operating out of Marco Island, Florida. The lab ships across four pillars: USE AI (the local-first ORANGEBOX cockpit, $1 once, license §4A legally bans switching to subscription), MAKE MONEY (the skil.ski skill marketplace), KNOW THE TRUTH (the /intel decoded-primary-source surface and The Founder's View nightly broadcast), and RESEARCH (ÆoNs Research — twelve manuscripts under CC-BY 4.0 plus the Lessons From Sci-Fi monograph, a comprehensive analytical survey of a century of AI in film and television). The lab takes zero markup on token costs, runs zero telemetry, and built its own website in one day inside the cockpit it sells.`;
