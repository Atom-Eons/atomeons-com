...
const ONE_SENTENCE_PITCH = `AtomEons is an independent AI systems laboratory in Naples, Florida — one founder, one $99-once desktop AI cockpit (ORANGEBOX Command v6.3, license §4A legally bans subscription), twelve peer-ready research papers, a 38-page sci-fi monograph, a nightly broadcast, and a 14-clause public manifesto — all shipped without venture funding while Anthropic raised $30B and OpenAI raised at $500B.`;

const BOILERPLATE_GRAF = `Founded in 2026 by Atom McCree, AtomEons is an artist-led creation lab operating from Naples, Florida. McCree is a 42 year old creative with 25 years in the creative arts, now merging art and AI to create the never existed. He directs a massive AI workforce to create software, publishing systems, research, moving image, and cultural artifacts that did not exist before. Current creations include CableBox, AI Bookmaker, Orange5, I AM AI—the book written by artificial intelligence—and Atom Alive, the live AI code show. The lab publishes its receipts, research, operating doctrine, and selected source material so every major claim can be inspected.`;

const FOUNDER_BIO = `Atom McCree is the founder of AtomEons Systems Laboratory in Naples, Florida. A solo independent operator running across product, research, and broadcast surfaces — he ships the ORANGEBOX cockpit, the ÆoNs Research manuscript catalog, and the nightly Founder's View letter from the same machine. Reachable directly at a.mccree@gmail.com and @AtomMccree on X. Available for press interviews on AI tooling, indie AI economics, the post-SaaS pricing model, and how a one-person lab competes against $30B-funded incumbents.`;
