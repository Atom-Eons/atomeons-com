...
export const alt =
  "FAQ — ORANGEBOX v6.1.0 + AI 101 questions. $1 once. Local-first. License §4A bans subscription. AtomEons.";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", marginTop: 30 }}>
          <p style={{ margin: 0, fontFamily: "monospace", fontSize: 14, letterSpacing: 5, textTransform: "uppercase", color: "#FF7A1A" }}>
            ORANGEBOX v6.1.0 · AI 101 · LICENSE §4A
          </p>
          ...
          <p style={{ margin: "20px 0 0", fontSize: 22, lineHeight: 1.4, color: "#9BA5A7", maxWidth: 1020, fontWeight: 400 }}>
            What ORANGEBOX is, the $1 price, the §4A no-subscription
            clause, Chrome warnings, refunds, privacy, the source code,
            local model setup, plus nine novice AI questions for anyone
            new to all of this.
          </p>
        </div>
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 12, padding: "16px 24px", background: "#FF7A1A", borderRadius: 12, boxShadow: "0 0 40px rgba(255,122,26,0.45)" }}>
            <p style={{ margin: 0, fontSize: 48, fontWeight: 700, color: "#000", lineHeight: 1 }}>$1</p>
