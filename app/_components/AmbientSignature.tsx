  ...
  return (
    <>
      ...
      <button
        ...
        aria-pressed={muted}
        // Wave 50 · 2026-06-12 · target-size · 36px still flagged ·
        // bumped to h-11 w-11 (44px · WCAG 2.5.5 AAA tier).
        className="fixed bottom-3 right-3 z-50 flex h-11 w-11 items-center justify-center rounded-full border border-[#1F242B] bg-[#08090B]/80 text-[#7a818a] backdrop-blur-sm transition-colors hover:border-[#22F0D5]/40 hover:text-[#22F0D5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22F0D5]/40"
