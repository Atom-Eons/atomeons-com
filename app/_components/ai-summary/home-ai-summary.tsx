  ...
  return (
    ...
    >
      ...
      <p className="font-serif text-[15px] leading-[1.55] text-[#F4F4F2] mb-6">
        AtomEons is a one-operator AI research lab based in Naples, Florida, run by Atom McCree, publishing routes, founders-view letters, books, and the ORANGEBOX local-AI runtime under CC-BY 4.0 by default.
      </p>
      <ul className="font-serif text-[14px] text-[#9CA3AF] list-disc pl-5 space-y-1.5 mb-6 marker:text-[#1F242B]">
        <li>Operator: Atom McCree, solo independent researcher and builder, Naples, FL.</li>
