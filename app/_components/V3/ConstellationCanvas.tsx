 ...
 * lab's 278 routes and 648 cross-route links.
 *
 ...
 *
 * Performance budget: ~278 × 6 force-update operations per relaxation
...
export function ConstellationCanvas() {
  ...
  useEffect(() => {
    ...
    // Lightweight force relaxation · O(N²) but N=278 so manageable
