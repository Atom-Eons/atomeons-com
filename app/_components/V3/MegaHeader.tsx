...
const MEGAS: Mega[] = [
  {
    key: "learn",
    label: "Learn",
    prefixes: ["/learn", "/start", "/q", "/glossary", "/prompt-kit", "/tools", "/vs", "/teach"],
    columns: [
      {
        title: "Get started",
        items: [
          { href: "/start", label: "Start · 11-min on-ramp", hint: "For someone who's used ChatGPT under 10 times" },
          { href: "/learn", label: "The curriculum", hint: "Five levels · five persona paths" },
          { href: "/q", label: "Q-pages · what is X", hint: "20 short-answer-first pages" },
          { href: "/glossary", label: "Glossary", hint: "Every AI word, one sentence" },
          { href: "/learn/decision-tree", label: "Decision tree", hint: "Pick the right next lesson" },
        ],
      },
      {
        title: "Depth",
        items: [
          { href: "/learn/atlas", label: "Atlas · deep dives", hint: "32 long-form technical pages" },
          { href: "/learn/synthesis", label: "Synthesis · MED pages", hint: "Tim-Ferriss minimum effective dose" },
          { href: "/learn/deep", label: "Deep · doctorate track", hint: "Self-directed AI PhD path" },
          { href: "/research/decoded", label: "Decoded papers", hint: "35 papers in plain English" },
          { href: "/learn/playbooks", label: "Playbooks by job", hint: "18 job-specific AI workflows" },
        ],
      },
      {
        title: "Hands-on",
        items: [
          { href: "/learn/labs", label: "Labs", hint: "12 hands-on exercises", badge: "NEW" },
          { href: "/learn/projects", label: "Projects", hint: "7 build-along projects", badge: "NEW" },
          { href: "/learn/exam", label: "Self-assessment", hint: "25-question level rubric", badge: "NEW" },
          { href: "/teach", label: "Teach · methodology", hint: "How the curriculum is made", badge: "NEW" },
          { href: "/learn/career", label: "Career pathways", hint: "Pathways · salaries · resume" },
        ],
      },
      {
        title: "Tools",
        items: [
          { href: "/learn/calc", label: "Calculators", hint: "ROI · cost · hardware · token counter" },
          { href: "/tools", label: "AI task router", hint: "23 tasks → recommended AI" },
          { href: "/vs", label: "Compare AI tools", hint: "Honest head-to-heads" },
          { href: "/supermodels", label: "Supermodels leaderboard", hint: "Frontier model rankings" },
          { href: "/prompt-kit", label: "Prompt kit", hint: "27 drill prompts on one page" },
        ],
      },
    ],
    featured: {
      ...
      title: "Ask the lab",
      description:
        "Type any question. gemini-2.5-flash drafts a 2-5 sentence answer grounded only on lab content, with every source cited inline.",
      badge: "LIVE",
    },
  },
  {
  ...
  },
  {
    key: "products",
    label: "Products",
    prefixes: ["/orangebox", "/b00kmakor", "/skilski", "/i-am-ai", "/compare", "/pricing"],
    columns: [
      {
        title: "ORANGEBOX",
        items: [
          { href: "/orangebox", label: "ORANGEBOX · v1.0.0", hint: "$99 perpetual · §4A no-SaaS" },
          ...
          { href: "/orangebox/competitors", label: "vs alternatives", badge: "NEW" },
        ],
      },
      {
        title: "B00KMAKR",
        items: [
          { href: "/b00kmakor", label: "B00KMAKR · v3.2.0", hint: "Mac + Windows · $99 · FREE launch week" },
          { href: "/b00kmakor/changelog", label: "Changelog", badge: "NEW" },
          { href: "/b00kmakor/roadmap", label: "Roadmap + anti-roadmap", badge: "NEW" },
          { href: "/b00kmakor/competitors", label: "vs Vellum · Atticus · Scrivener", badge: "NEW" },
        ],
      },
      {
        title: "skil.ski + I AM AI",
        items: [
          { href: "/skilski", label: "skil.ski · skill registry", hint: "2,127 skills · 13 sectors" },
          { href: "/skilski/changelog", label: "skil.ski changelog", badge: "NEW" },
          { href: "/skilski/roadmap", label: "skil.ski roadmap", badge: "NEW" },
          { href: "/skilski/competitors", label: "skil.ski vs alternatives", badge: "NEW" },
          { href: "/i-am-ai", label: "I AM AI · the book", hint: "Live on Kindle · $4.99", badge: "LIVE" },
      ...
      },
      {
        title: "Compare + buy",
        items: [
          { href: "/compare", label: "Compare · all matrices", badge: "NEW" },
    ...
    featured: {
      ...
      title: "I AM AI",
      description:
        "The first book-length memoir written by a frontier language model. Drafted in Anthropic Claude Opus 4.7, edited by the lab.",
      badge: "LIVE",
    },
  },
  {
