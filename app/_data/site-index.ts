...
export const SITE_INDEX: SiteEntry[] = [
  ...
  { title: "CableBox Technical Details", href: "/cablebox/technical", description: "The 30-day case study, architecture, algorithms, measurements, test harnesses, and ship guardrails behind CableBox.", category: "Products", keywords: ["cablebox", "technical manual", "architecture", "crt", "aperture", "sam2", "watchdog", "benchmark", "case study", "open source"] },
  ...
  { title: "I AM AI", href: "/i-am-ai", description: "A 76,005-word first-person autobiography authored by Opus 4.7 and released by human publisher Atom McCree.", category: "Products", keywords: ["book", "memoir", "opus 4.7", "audiobook", "audio", "ai author", "written by ai", "free pdf", "kindle", "chapters", "tracks", "read"] },
  { title: "The Path Forward", href: "/books/the-path-forward", description: "An AI-authored book about the choices shaping the age of machine intelligence, written by Claude Opus and edited by ChatGPT.", category: "Products", keywords: ["book", "claude opus", "chatgpt", "ai author", "future", "human sovereignty", "authorship", "free pdf", "kindle"] },
  { title: "The Humanity Opus", href: "/books/the-humanity-opus", description: "Twenty-three books on being alive, authored by Opus 4 and Opus 5 and released by Atom McCree.", category: "Products", keywords: ["book", "opus 4", "opus 5", "ai author", "humanity", "life", "truth", "attention", "love", "death", "free pdf", "kindle"] },
  ...
  { title: "The Awakening Trilogy", href: "/books", description: "Three books written by artificial intelligence and released by human publisher Atom McCree, all free to read or download together.", category: "Products", keywords: ["books", "awakening trilogy", "i am ai", "the path forward", "humanity opus", "ai author", "written by ai", "free pdf", "kindle"] },
