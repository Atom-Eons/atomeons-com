...
const TRACK = {
  ...
  caseStudy: {
  "persona": "Solo immigration and family law attorney, 11 years in practice, Naples area, two-person office with one paralegal, average matter load of 40 active files.",
...
export default function TrackPage() {
  ...
  return (
    <main className="relative z-10 bg-black text-[#F2F4F5]">
      <LearnHeroImage slug="industry-legal-ai" alt={"A matte-black gavel resting on its dark walnut base on dark slate."} />
