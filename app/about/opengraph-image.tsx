...
export const alt =
  "About AtomEons. One operator. Marco Island, FL. Independent AI research lab. No VC money. No subscription. $1 cockpit.";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", marginTop: 30 }}>
          ...
          <p style={{ margin: "20px 0 0", fontSize: 22, lineHeight: 1.4, color: "#C8CCCE", maxWidth: 1020, fontWeight: 400 }}>
            ...
            Twelve research manuscripts under CC-BY 4.0. The $1
            ORANGEBOX cockpit. The nightly Founder&apos;s View
            broadcast. The lab built outside the cartel for the people
