---
name: barber-new-client-intake-form
display_name: "New Client Intake Form Generator"
description: "Generate first-visit intake form with allergy history, services interested, contact, photo consent, no-show acknowledgement."
...
# New Client Intake Form Generator

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Generate first-visit intake form with allergy history, services interested, contact, photo consent, no-show acknowledgement.
...
1. Capture inputs via MCP tool `capture_inputs_barber_new_client_intake_form`
