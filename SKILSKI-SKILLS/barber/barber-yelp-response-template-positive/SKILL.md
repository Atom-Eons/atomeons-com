---
name: barber-yelp-response-template-positive
display_name: "Yelp Review Response (Positive)"
description: "Yelp-platform-optimized positive-review response."
...
mcp_tools:
  - render_barber_yelp_response_template_positive
  - capture_inputs_barber_yelp_response_template_positive
tools: Read, Write
...
# Yelp Review Response (Positive)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Yelp-platform-optimized positive-review response.
...
1. Capture inputs via MCP tool `capture_inputs_barber_yelp_response_template_positive`
