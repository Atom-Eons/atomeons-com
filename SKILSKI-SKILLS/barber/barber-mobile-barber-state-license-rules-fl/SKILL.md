---
name: barber-mobile-barber-state-license-rules-fl
display_name: "FL Mobile Barber License Rules"
description: "FL DBPR rules for mobile barbering: business license + insurance + sanitation + transport rules."
...
state: FL
mcp_tools:
  - render_barber_mobile_barber_state_license_rules_fl
  - capture_inputs_barber_mobile_barber_state_license_rules_fl
tools: Read, Write
...
# FL Mobile Barber License Rules

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

FL DBPR rules for mobile barbering: business license + insurance + sanitation + transport rules.
...
1. Capture inputs via MCP tool `capture_inputs_barber_mobile_barber_state_license_rules_fl`
