---
name: barber-email-vip-loyalty-club-invite
display_name: "VIP Loyalty Club Invite"
description: "Email inviting top clients into VIP loyalty tier with priority booking + exclusive discounts."
...
mcp_tools:
  - render_barber_email_vip_loyalty_club_invite
  - capture_inputs_barber_email_vip_loyalty_club_invite
tools: Read, Write
...
# VIP Loyalty Club Invite

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Email inviting top clients into VIP loyalty tier with priority booking + exclusive discounts.
...
1. Capture inputs via MCP tool `capture_inputs_barber_email_vip_loyalty_club_invite`
