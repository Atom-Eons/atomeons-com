---
name: barber-booth-rental-agreement-template-percentage
display_name: "Booth Rental Agreement (Percentage Split)"
description: "Booth contract with percentage-based commission split (e.g., 60/40 or 70/30); careful drafting to preserve independent-contractor status."
...
mcp_tools:
  - render_barber_booth_rental_agreement_template_percentage
  - capture_inputs_barber_booth_rental_agreement_template_percentage
tools: Read, Write
...
# Booth Rental Agreement (Percentage Split)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Booth contract with percentage-based commission split (e.g., 60/40 or 70/30); careful drafting to preserve independent-contractor status.
...
- `renter_legal_name`
- `state`
- `percentage_to_renter`
- `station_designation`

## Outputs

- `percentage_split_agreement.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_booth_rental_agreement_template_percentage`
