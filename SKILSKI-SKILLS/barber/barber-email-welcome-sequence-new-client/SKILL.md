---
name: barber-email-welcome-sequence-new-client
display_name: "New Client Welcome Email Sequence"
description: "5-email welcome sequence post first visit: thank-you, care tips, product, referral ask, next-visit reminder."
...
mcp_tools:
  - render_barber_email_welcome_sequence_new_client
  - capture_inputs_barber_email_welcome_sequence_new_client
tools: Read, Write
...
5-email welcome sequence post first visit: thank-you, care tips, product, referral ask, next-visit reminder.
...
1. Capture inputs via MCP tool `capture_inputs_barber_email_welcome_sequence_new_client`
