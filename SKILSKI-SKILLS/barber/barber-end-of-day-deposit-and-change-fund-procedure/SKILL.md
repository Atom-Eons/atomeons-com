---
name: barber-end-of-day-deposit-and-change-fund-procedure
display_name: "End-of-Day Deposit + Change Fund Procedure"
description: "Daily close procedure: cash count, change fund maintenance, deposit slip, reconciliation against POS."
...
mcp_tools:
  - render_barber_end_of_day_deposit_and_change_fund_procedure
  - capture_inputs_barber_end_of_day_deposit_and_change_fund_procedure
tools: Read, Write
...
# End-of-Day Deposit + Change Fund Procedure

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Daily close procedure: cash count, change fund maintenance, deposit slip, reconciliation against POS.
...
1. Capture inputs via MCP tool `capture_inputs_barber_end_of_day_deposit_and_change_fund_procedure`
