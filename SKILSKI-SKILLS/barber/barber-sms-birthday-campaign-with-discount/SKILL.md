---
name: barber-sms-birthday-campaign-with-discount
display_name: "Birthday SMS Campaign with Discount"
description: "Auto-trigger birthday SMS + discount; redemption tracking."
...
mcp_tools:
  - render_barber_sms_birthday_campaign_with_discount
  - capture_inputs_barber_sms_birthday_campaign_with_discount
tools: Read, Write
...
# Birthday SMS Campaign with Discount

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Auto-trigger birthday SMS + discount; redemption tracking.

## Required Inputs

- `client_database_with_birthdays`
- `discount_offer`

## Outputs

- `campaign.csv`
- `redemption_tracker.xlsx`
...
1. Capture inputs via MCP tool `capture_inputs_barber_sms_birthday_campaign_with_discount`
