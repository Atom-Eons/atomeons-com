---
name: barber-email-referral-rewards-template
display_name: "Referral Rewards Email Template"
description: "Refer-a-friend email with reward for both referrer and friend."
...
mcp_tools:
  - render_barber_email_referral_rewards_template
  - capture_inputs_barber_email_referral_rewards_template
tools: Read, Write
...
# Referral Rewards Email Template

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Refer-a-friend email with reward for both referrer and friend.
...
1. Capture inputs via MCP tool `capture_inputs_barber_email_referral_rewards_template`
