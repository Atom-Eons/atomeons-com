---
name: barber-cancellation-policy-with-deposit
display_name: "Cancellation Policy with Deposit Requirement"
description: "Deposit-required cancellation policy, deposit-handling procedure, refund window, terms shown at booking."
...
mcp_tools:
  - render_barber_cancellation_policy_with_deposit
  - capture_inputs_barber_cancellation_policy_with_deposit
tools: Read, Write
...
# Cancellation Policy with Deposit Requirement

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Deposit-required cancellation policy, deposit-handling procedure, refund window, terms shown at booking.
...
1. Capture inputs via MCP tool `capture_inputs_barber_cancellation_policy_with_deposit`
