---
name: barber-state-license-renewal-ca
display_name: "CA Barber License Renewal"
description: "CA Board of Barbering & Cosmetology renewal cycle. Continuing education hours required."
...
state: CA
mcp_tools:
  - render_barber_state_license_renewal_ca
  - capture_inputs_barber_state_license_renewal_ca
tools: Read, Write
...
# CA Barber License Renewal

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

CA Board of Barbering & Cosmetology renewal cycle. Continuing education hours required.
...
1. Capture inputs via MCP tool `capture_inputs_barber_state_license_renewal_ca`
