---
name: barber-referral-rewards-program-design
display_name: "Referral Rewards Program Design"
description: "Referral program design with reward for both referrer + referred. Tracking template."
...
mcp_tools:
  - render_barber_referral_rewards_program_design
  - capture_inputs_barber_referral_rewards_program_design
tools: Read, Write
...
# Referral Rewards Program Design

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Referral program design with reward for both referrer + referred. Tracking template.
...
1. Capture inputs via MCP tool `capture_inputs_barber_referral_rewards_program_design`
