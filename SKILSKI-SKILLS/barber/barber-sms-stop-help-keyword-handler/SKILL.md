---
name: barber-sms-stop-help-keyword-handler
display_name: "STOP/HELP Keyword Handler"
description: "Keyword automation rules for SMS platforms (Twilio/EZTexting/SimpleTexting): STOP confirms opt-out, HELP returns shop info."
...
mcp_tools:
  - render_barber_sms_stop_help_keyword_handler
  - capture_inputs_barber_sms_stop_help_keyword_handler
tools: Read, Write
...
# STOP/HELP Keyword Handler

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Keyword automation rules for SMS platforms (Twilio/EZTexting/SimpleTexting): STOP confirms opt-out, HELP returns shop info.
...
- `keyword_handler.json`
- `platform_setup_walkthrough.md`
...
1. Capture inputs via MCP tool `capture_inputs_barber_sms_stop_help_keyword_handler`
