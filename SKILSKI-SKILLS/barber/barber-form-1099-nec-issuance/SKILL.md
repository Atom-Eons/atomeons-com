---
name: barber-form-1099-nec-issuance
display_name: "Form 1099-NEC Issuance to Booth Renters"
description: "Issue 1099-NEC to each booth renter paid $600+/yr. Due Jan 31. E-file via IRS FIRE preferred."
...
mcp_tools:
  - render_barber_form_1099_nec_issuance
  - capture_inputs_barber_form_1099_nec_issuance
tools: Read, Write
...
# Form 1099-NEC Issuance to Booth Renters

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Issue 1099-NEC to each booth renter paid $600+/yr. Due Jan 31. E-file via IRS FIRE preferred.
...
1. Capture inputs via MCP tool `capture_inputs_barber_form_1099_nec_issuance`
