---
name: barber-allergy-consultation-script
display_name: "Allergy + Chemical Service Consultation Script"
description: "Pre-service consultation script for color/perm/relaxer with patch-test recommendation 24-48 hrs prior, waiver of liability if declined."
...
mcp_tools:
  - render_barber_allergy_consultation_script
  - capture_inputs_barber_allergy_consultation_script
tools: Read, Write
...
# Allergy + Chemical Service Consultation Script

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Pre-service consultation script for color/perm/relaxer with patch-test recommendation 24-48 hrs prior, waiver of liability if declined.
...
- `consultation_script.pdf`
- `patch_test_record.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_allergy_consultation_script`
