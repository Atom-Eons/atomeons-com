---
name: barber-shop-license-application-state
display_name: "Shop License Application (State-Specific)"
description: "State barber-shop license (separate from individual license). Sanitation requirements + inspection schedule."
...
mcp_tools:
  - render_barber_shop_license_application_state
  - capture_inputs_barber_shop_license_application_state
tools: Read, Write
...
# Shop License Application (State-Specific)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

State barber-shop license (separate from individual license). Sanitation requirements + inspection schedule.
...
1. Capture inputs via MCP tool `capture_inputs_barber_shop_license_application_state`
