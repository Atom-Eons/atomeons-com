---
name: barber-shop-llc-formation-fl
display_name: "FL Shop LLC Formation"
description: "FL LLC formation via SunBiz: $125 filing, annual report due May 1 ($138.75)."
...
state: FL
mcp_tools:
  - render_barber_shop_llc_formation_fl
  - capture_inputs_barber_shop_llc_formation_fl
tools: Read, Write
...
# FL Shop LLC Formation

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

FL LLC formation via SunBiz: $125 filing, annual report due May 1 ($138.75).
...
- `fl_llc_prefilled.pdf`
- `sunbiz_walkthrough.md`
...
1. Capture inputs via MCP tool `capture_inputs_barber_shop_llc_formation_fl`
