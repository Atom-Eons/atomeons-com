---
name: barber-google-business-profile-monthly-post-template
display_name: "GBP Monthly Post Template"
description: "Monthly post calendar for Google Business Profile (4 posts/month minimum for engagement)."
...
mcp_tools:
  - render_barber_google_business_profile_monthly_post_template
  - capture_inputs_barber_google_business_profile_monthly_post_template
tools: Read, Write
...
# GBP Monthly Post Template

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Monthly post calendar for Google Business Profile (4 posts/month minimum for engagement).
...
1. Capture inputs via MCP tool `capture_inputs_barber_google_business_profile_monthly_post_template`
