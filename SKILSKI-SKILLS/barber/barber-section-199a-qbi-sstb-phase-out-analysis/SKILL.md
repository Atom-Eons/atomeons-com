---
name: barber-section-199a-qbi-sstb-phase-out-analysis
display_name: "§199A QBI SSTB Phase-Out Analysis"
description: "Barbering is SSTB (Specified Service Trade or Business). Run phase-out for 2024 thresholds: single $191,950 / MFJ $383,900."
...
mcp_tools:
  - render_barber_section_199a_qbi_sstb_phase_out_analysis
  - capture_inputs_barber_section_199a_qbi_sstb_phase_out_analysis
tools: Read, Write
...
# §199A QBI SSTB Phase-Out Analysis

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Barbering is SSTB (Specified Service Trade or Business). Run phase-out for 2024 thresholds: single $191,950 / MFJ $383,900.
...
1. Capture inputs via MCP tool `capture_inputs_barber_section_199a_qbi_sstb_phase_out_analysis`
