---
name: barber-apprentice-program-setup-tx
display_name: "TX Apprentice Program Setup"
description: "TDLR-approved apprentice sponsorship: 1,500 hrs supervised practice + curriculum + records."
...
state: TX
mcp_tools:
  - render_barber_apprentice_program_setup_tx
  - capture_inputs_barber_apprentice_program_setup_tx
tools: Read, Write
...
# TX Apprentice Program Setup

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

TDLR-approved apprentice sponsorship: 1,500 hrs supervised practice + curriculum + records.
...
1. Capture inputs via MCP tool `capture_inputs_barber_apprentice_program_setup_tx`
