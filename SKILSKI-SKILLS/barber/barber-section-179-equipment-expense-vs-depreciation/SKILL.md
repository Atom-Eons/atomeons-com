---
name: barber-section-179-equipment-expense-vs-depreciation
display_name: "§179 Equipment Expense vs Depreciation"
description: "Compare §179 immediate expense (up to $1.16M 2024 limit) vs MACRS depreciation for clipper / chair / equipment purchases."
...
mcp_tools:
  - render_barber_section_179_equipment_expense_vs_depreciation
  - capture_inputs_barber_section_179_equipment_expense_vs_depreciation
tools: Read, Write
...
# §179 Equipment Expense vs Depreciation

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Compare §179 immediate expense (up to $1.16M 2024 limit) vs MACRS depreciation for clipper / chair / equipment purchases.

## Required Inputs

- `equipment_purchases[]`
- `business_year_income`

## Outputs

- `equipment_decision.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_section_179_equipment_expense_vs_depreciation`
