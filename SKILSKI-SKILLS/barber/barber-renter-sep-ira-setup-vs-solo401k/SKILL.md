---
name: barber-renter-sep-ira-setup-vs-solo401k
display_name: "SEP-IRA vs Solo 401(k) Decision"
description: "Comparison: SEP-IRA (25% net SE income, simple) vs Solo 401(k) (employee + employer contributions, higher max). Run for client income."
...
mcp_tools:
  - render_barber_renter_sep_ira_setup_vs_solo401k
  - capture_inputs_barber_renter_sep_ira_setup_vs_solo401k
tools: Read, Write
...
# SEP-IRA vs Solo 401(k) Decision

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Comparison: SEP-IRA (25% net SE income, simple) vs Solo 401(k) (employee + employer contributions, higher max). Run for client income.

## Required Inputs

- `net_se_income`
- `spouse_in_business`
- `desired_max_contribution`

## Outputs

- `retirement_decision.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_renter_sep_ira_setup_vs_solo401k`
