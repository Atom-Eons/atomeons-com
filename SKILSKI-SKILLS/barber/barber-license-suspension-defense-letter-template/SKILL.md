---
name: barber-license-suspension-defense-letter-template
display_name: "License Suspension Defense Letter"
description: "Initial defense letter to state board for license suspension complaint. References attorney engagement."
...
mcp_tools:
  - render_barber_license_suspension_defense_letter_template
  - capture_inputs_barber_license_suspension_defense_letter_template
tools: Read, Write
...
# License Suspension Defense Letter

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Initial defense letter to state board for license suspension complaint. References attorney engagement.
...
1. Capture inputs via MCP tool `capture_inputs_barber_license_suspension_defense_letter_template`
