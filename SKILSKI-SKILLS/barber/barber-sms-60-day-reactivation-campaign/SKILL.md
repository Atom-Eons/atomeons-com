---
name: barber-sms-60-day-reactivation-campaign
display_name: "60-Day Reactivation SMS Campaign"
description: "Reactivate 60+ days lapsed clients with stronger offer."
...
mcp_tools:
  - render_barber_sms_60_day_reactivation_campaign
  - capture_inputs_barber_sms_60_day_reactivation_campaign
tools: Read, Write
...
# 60-Day Reactivation SMS Campaign

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Reactivate 60+ days lapsed clients with stronger offer.
...
1. Capture inputs via MCP tool `capture_inputs_barber_sms_60_day_reactivation_campaign`
