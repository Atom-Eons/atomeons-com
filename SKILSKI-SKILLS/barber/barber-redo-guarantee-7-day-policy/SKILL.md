---
name: barber-redo-guarantee-7-day-policy
display_name: "7-Day Redo Guarantee Policy"
description: "7-day quality-guarantee redo policy: scope, exclusions, claim process."
...
mcp_tools:
  - render_barber_redo_guarantee_7_day_policy
  - capture_inputs_barber_redo_guarantee_7_day_policy
tools: Read, Write
...
# 7-Day Redo Guarantee Policy

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

7-day quality-guarantee redo policy: scope, exclusions, claim process.
...
1. Capture inputs via MCP tool `capture_inputs_barber_redo_guarantee_7_day_policy`
