---
name: barber-walk-in-vs-appointment-script
display_name: "Walk-In vs Appointment Triage Script"
description: "Phone + in-person triage script for handling walk-ins when appointments are full vs available."
...
mcp_tools:
  - render_barber_walk_in_vs_appointment_script
  - capture_inputs_barber_walk_in_vs_appointment_script
tools: Read, Write
...
# Walk-In vs Appointment Triage Script

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Phone + in-person triage script for handling walk-ins when appointments are full vs available.
...
1. Capture inputs via MCP tool `capture_inputs_barber_walk_in_vs_appointment_script`
