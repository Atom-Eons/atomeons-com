---
name: barber-pos-square-vs-clover-vs-toast-comparison
display_name: "POS Comparison (Square / Clover / Toast)"
description: "POS systems comparison for barber shop: features, fees, hardware cost, integrations."
...
mcp_tools:
  - render_barber_pos_square_vs_clover_vs_toast_comparison
  - capture_inputs_barber_pos_square_vs_clover_vs_toast_comparison
tools: Read, Write
...
# POS Comparison (Square / Clover / Toast)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

POS systems comparison for barber shop: features, fees, hardware cost, integrations.
...
1. Capture inputs via MCP tool `capture_inputs_barber_pos_square_vs_clover_vs_toast_comparison`
