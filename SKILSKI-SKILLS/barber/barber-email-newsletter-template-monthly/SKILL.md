---
name: barber-email-newsletter-template-monthly
display_name: "Monthly Email Newsletter Template"
description: "Monthly newsletter template: featured cut, shop news, product spotlight, customer-of-the-month."
...
mcp_tools:
  - render_barber_email_newsletter_template_monthly
  - capture_inputs_barber_email_newsletter_template_monthly
tools: Read, Write
...
Monthly newsletter template: featured cut, shop news, product spotlight, customer-of-the-month.
...
1. Capture inputs via MCP tool `capture_inputs_barber_email_newsletter_template_monthly`
