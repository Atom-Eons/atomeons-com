---
name: barber-shop-employee-handbook-template
display_name: "Shop Employee Handbook"
description: "Comprehensive employee handbook: schedule, breaks (state-specific), tips, no-show, dress code, PTO, termination, anti-harassment."
...
mcp_tools:
  - render_barber_shop_employee_handbook_template
  - capture_inputs_barber_shop_employee_handbook_template
tools: Read, Write
...
# Shop Employee Handbook

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Comprehensive employee handbook: schedule, breaks (state-specific), tips, no-show, dress code, PTO, termination, anti-harassment.
...
1. Capture inputs via MCP tool `capture_inputs_barber_shop_employee_handbook_template`
