---
name: barber-shop-quarterly-941-prep
display_name: "Quarterly 941 Employment Tax"
description: "Form 941 quarterly federal employment tax return for shop with W-2 employees. FIT + FICA computation."
...
mcp_tools:
  - render_barber_shop_quarterly_941_prep
  - capture_inputs_barber_shop_quarterly_941_prep
tools: Read, Write
...
# Quarterly 941 Employment Tax

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Form 941 quarterly federal employment tax return for shop with W-2 employees. FIT + FICA computation.
...
- `form941_prefilled.pdf`
- `deposit_schedule.ics`
...
1. Capture inputs via MCP tool `capture_inputs_barber_shop_quarterly_941_prep`
