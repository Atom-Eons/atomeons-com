---
name: barber-form-2106-unreimbursed-employee-expense-state
display_name: "State Form 2106-Equivalent (Where Allowed)"
description: "Some states still allow unreimbursed employee business expenses (post-TCJA federal disallowed). State-specific check."
...
mcp_tools:
  - render_barber_form_2106_unreimbursed_employee_expense_state
  - capture_inputs_barber_form_2106_unreimbursed_employee_expense_state
tools: Read, Write
...
# State Form 2106-Equivalent (Where Allowed)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Some states still allow unreimbursed employee business expenses (post-TCJA federal disallowed). State-specific check.

## Required Inputs

- `state`
- `employee_unreimbursed_expenses`

## Outputs

- `state_2106_screen.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_form_2106_unreimbursed_employee_expense_state`
