---
name: barber-daily-revenue-report-spreadsheet-template
display_name: "Daily Revenue Report Template"
description: "Daily revenue tracking spreadsheet: services breakdown, tips, deposit, products sold, expense."
...
mcp_tools:
  - render_barber_daily_revenue_report_spreadsheet_template
  - capture_inputs_barber_daily_revenue_report_spreadsheet_template
tools: Read, Write
...
Daily revenue tracking spreadsheet: services breakdown, tips, deposit, products sold, expense.
...
1. Capture inputs via MCP tool `capture_inputs_barber_daily_revenue_report_spreadsheet_template`
