---
name: barber-shop-2553-s-corp-election
display_name: "Form 2553 S-Corp Election"
description: "IRS Form 2553 to elect S-corp tax treatment. Eligibility check (≤100 shareholders, single class, US-only). Within 2 months 15 days OR Rev. Proc. 2013-30 late relief."
...
mcp_tools:
  - render_barber_shop_2553_s_corp_election
  - capture_inputs_barber_shop_2553_s_corp_election
tools: Read, Write
...
IRS Form 2553 to elect S-corp tax treatment. Eligibility check (≤100 shareholders, single class, US-only). Within 2 months 15 days OR Rev. Proc. 2013-30 late relief.
...
- `form2553_prefilled.pdf`
- `shareholder_consent_template.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_shop_2553_s_corp_election`
