---
name: barber-eitc-self-employment-eligibility
display_name: "EITC for Self-Employed Barber"
description: "Earned Income Tax Credit for low-to-moderate-income self-employed barber. Schedule C income counts as earned income."
...
mcp_tools:
  - render_barber_eitc_self_employment_eligibility
  - capture_inputs_barber_eitc_self_employment_eligibility
tools: Read, Write
...
# EITC for Self-Employed Barber

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Earned Income Tax Credit for low-to-moderate-income self-employed barber. Schedule C income counts as earned income.
...
1. Capture inputs via MCP tool `capture_inputs_barber_eitc_self_employment_eligibility`
