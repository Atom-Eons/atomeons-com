---
name: barber-yelp-response-template-negative
display_name: "Yelp Review Response (Negative)"
description: "Yelp negative-review response with private message follow-up."
...
mcp_tools:
  - render_barber_yelp_response_template_negative
  - capture_inputs_barber_yelp_response_template_negative
tools: Read, Write
...
# Yelp Review Response (Negative)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Yelp negative-review response with private message follow-up.
...
1. Capture inputs via MCP tool `capture_inputs_barber_yelp_response_template_negative`
