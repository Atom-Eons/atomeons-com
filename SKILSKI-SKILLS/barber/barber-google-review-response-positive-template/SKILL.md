---
name: barber-google-review-response-positive-template
display_name: "Google Review Response (Positive)"
description: "Personalized positive-review response template; SEO-optimized with shop name + service type."
...
mcp_tools:
  - render_barber_google_review_response_positive_template
  - capture_inputs_barber_google_review_response_positive_template
tools: Read, Write
...
# Google Review Response (Positive)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Personalized positive-review response template; SEO-optimized with shop name + service type.
...
1. Capture inputs via MCP tool `capture_inputs_barber_google_review_response_positive_template`
