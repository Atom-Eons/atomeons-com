---
name: barber-disability-income-insurance
display_name: "Self-Employed Disability Income Insurance"
description: "Income protection if barber cannot work due to injury/illness. ~$30-150/mo."
...
mcp_tools:
  - render_barber_disability_income_insurance
  - capture_inputs_barber_disability_income_insurance
tools: Read, Write
...
# Self-Employed Disability Income Insurance

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Income protection if barber cannot work due to injury/illness. ~$30-150/mo.
...
1. Capture inputs via MCP tool `capture_inputs_barber_disability_income_insurance`
