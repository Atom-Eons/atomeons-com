---
name: barber-general-liability-insurance-shopping-guide
display_name: "General Liability Insurance Shopping"
description: "GL ($1M/$2M typical). Provider comparison: Hiscox, Next Insurance, Thimble, NABBA. ~$30-80/mo."
...
mcp_tools:
  - render_barber_general_liability_insurance_shopping_guide
  - capture_inputs_barber_general_liability_insurance_shopping_guide
tools: Read, Write
...
# General Liability Insurance Shopping

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

GL ($1M/$2M typical). Provider comparison: Hiscox, Next Insurance, Thimble, NABBA. ~$30-80/mo.
...
1. Capture inputs via MCP tool `capture_inputs_barber_general_liability_insurance_shopping_guide`
