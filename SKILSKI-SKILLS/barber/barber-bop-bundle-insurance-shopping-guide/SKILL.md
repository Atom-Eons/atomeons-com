---
name: barber-bop-bundle-insurance-shopping-guide
display_name: "Business Owner Policy (BOP) Bundle"
description: "BOP bundles GL + property + business interruption. ~$40-120/mo. Compare against standalone GL+PL."
...
mcp_tools:
  - render_barber_bop_bundle_insurance_shopping_guide
  - capture_inputs_barber_bop_bundle_insurance_shopping_guide
tools: Read, Write
...
# Business Owner Policy (BOP) Bundle

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

BOP bundles GL + property + business interruption. ~$40-120/mo. Compare against standalone GL+PL.
...
1. Capture inputs via MCP tool `capture_inputs_barber_bop_bundle_insurance_shopping_guide`
