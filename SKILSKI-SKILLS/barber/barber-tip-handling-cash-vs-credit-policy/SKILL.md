---
name: barber-tip-handling-cash-vs-credit-policy
display_name: "Tip Handling Policy (Cash vs Credit)"
description: "How tips are handled — cash retained by barber, credit-card tips processed via POS. Tax + reporting implications."
...
mcp_tools:
  - render_barber_tip_handling_cash_vs_credit_policy
  - capture_inputs_barber_tip_handling_cash_vs_credit_policy
tools: Read, Write
...
# Tip Handling Policy (Cash vs Credit)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

How tips are handled — cash retained by barber, credit-card tips processed via POS. Tax + reporting implications.

## Required Inputs

- `employees_or_renters`
- `pos_used`
...
1. Capture inputs via MCP tool `capture_inputs_barber_tip_handling_cash_vs_credit_policy`
