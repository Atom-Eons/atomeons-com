---
name: barber-renter-business-checking-account-setup
display_name: "Business Checking Account Setup Guide"
description: "How to open business checking; required docs (EIN, articles, ID); recommended banks (online + brick-and-mortar)."
...
mcp_tools:
  - render_barber_renter_business_checking_account_setup
  - capture_inputs_barber_renter_business_checking_account_setup
tools: Read, Write
...
# Business Checking Account Setup Guide

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

How to open business checking; required docs (EIN, articles, ID); recommended banks (online + brick-and-mortar).
...
- `checking_setup_walkthrough.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_renter_business_checking_account_setup`
