---
name: barber-w9-collection-from-shop-letter
display_name: "W-9 Collection Letter from Shop to Renter"
description: "Letter requesting Form W-9 from booth renter; explains 1099-NEC reporting requirement; due Jan 31 of following year."
...
mcp_tools:
  - render_barber_w9_collection_from_shop_letter
  - capture_inputs_barber_w9_collection_from_shop_letter
tools: Read, Write
...
# W-9 Collection Letter from Shop to Renter

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Letter requesting Form W-9 from booth renter; explains 1099-NEC reporting requirement; due Jan 31 of following year.
...
1. Capture inputs via MCP tool `capture_inputs_barber_w9_collection_from_shop_letter`
