---
name: barber-photo-video-release-template
display_name: "Photo + Video Marketing Release"
description: "Client release for use of before/after images on Instagram, TikTok, Google Business Profile, shop website."
...
mcp_tools:
  - render_barber_photo_video_release_template
  - capture_inputs_barber_photo_video_release_template
tools: Read, Write
...
Client release for use of before/after images on Instagram, TikTok, Google Business Profile, shop website.
...
1. Capture inputs via MCP tool `capture_inputs_barber_photo_video_release_template`
