---
name: barber-renter-disability-insurance-shopping-guide
display_name: "Disability Income Insurance Shopping Guide"
description: "Income protection insurance for self-employed barber; provider comparison; how-to-buy + reasonable premium ranges."
...
mcp_tools:
  - render_barber_renter_disability_insurance_shopping_guide
  - capture_inputs_barber_renter_disability_insurance_shopping_guide
tools: Read, Write
...
# Disability Income Insurance Shopping Guide

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Income protection insurance for self-employed barber; provider comparison; how-to-buy + reasonable premium ranges.
...
1. Capture inputs via MCP tool `capture_inputs_barber_renter_disability_insurance_shopping_guide`
