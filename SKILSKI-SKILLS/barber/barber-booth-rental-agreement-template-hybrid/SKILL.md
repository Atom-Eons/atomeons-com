---
name: barber-booth-rental-agreement-template-hybrid
display_name: "Booth Rental Agreement (Hybrid)"
description: "Hybrid base-rent + percentage above threshold; common for high-volume booth renters."
...
mcp_tools:
  - render_barber_booth_rental_agreement_template_hybrid
  - capture_inputs_barber_booth_rental_agreement_template_hybrid
tools: Read, Write
...
# Booth Rental Agreement (Hybrid)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Hybrid base-rent + percentage above threshold; common for high-volume booth renters.
...
1. Capture inputs via MCP tool `capture_inputs_barber_booth_rental_agreement_template_hybrid`
