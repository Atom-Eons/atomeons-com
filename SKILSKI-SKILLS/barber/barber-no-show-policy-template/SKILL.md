---
name: barber-no-show-policy-template
display_name: "No-Show Policy Template"
description: "Drafted policy with notice periods, fees, and posting requirements; signed at first visit or via online booking."
...
mcp_tools:
  - render_barber_no_show_policy_template
  - capture_inputs_barber_no_show_policy_template
tools: Read, Write
...
Drafted policy with notice periods, fees, and posting requirements; signed at first visit or via online booking.
...
1. Capture inputs via MCP tool `capture_inputs_barber_no_show_policy_template`
