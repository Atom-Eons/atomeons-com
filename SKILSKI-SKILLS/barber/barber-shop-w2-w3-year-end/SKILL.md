---
name: barber-shop-w2-w3-year-end
display_name: "Year-End W-2 / W-3"
description: "W-2 to each employee + W-3 transmittal to SSA by Jan 31."
...
mcp_tools:
  - render_barber_shop_w2_w3_year_end
  - capture_inputs_barber_shop_w2_w3_year_end
tools: Read, Write
...
W-2 to each employee + W-3 transmittal to SSA by Jan 31.
...
1. Capture inputs via MCP tool `capture_inputs_barber_shop_w2_w3_year_end`
