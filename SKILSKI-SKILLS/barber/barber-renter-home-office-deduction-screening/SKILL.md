---
name: barber-renter-home-office-deduction-screening
display_name: "Home Office Deduction Screen (Mobile Barbers)"
description: "Form 8829 screening for mobile barber with dedicated home space; regular and exclusive use test; computation worksheet."
...
mcp_tools:
  - render_barber_renter_home_office_deduction_screening
  - capture_inputs_barber_renter_home_office_deduction_screening
tools: Read, Write
...
# Home Office Deduction Screen (Mobile Barbers)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Form 8829 screening for mobile barber with dedicated home space; regular and exclusive use test; computation worksheet.

## Required Inputs

- `home_total_sqft`
- `office_sqft`
- `home_expenses_annual`

## Outputs

- `home_office_screen.pdf`
- `8829_prep.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_renter_home_office_deduction_screening`
