---
name: barber-google-review-response-negative-template
display_name: "Google Review Response (Negative)"
description: "De-escalating, professional negative-review response that invites private resolution; protects brand."
...
mcp_tools:
  - render_barber_google_review_response_negative_template
  - capture_inputs_barber_google_review_response_negative_template
tools: Read, Write
...
# Google Review Response (Negative)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

De-escalating, professional negative-review response that invites private resolution; protects brand.
...
1. Capture inputs via MCP tool `capture_inputs_barber_google_review_response_negative_template`
