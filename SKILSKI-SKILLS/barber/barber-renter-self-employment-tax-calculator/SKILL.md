---
name: barber-renter-self-employment-tax-calculator
display_name: "Self-Employment Tax Calculator"
description: "SE tax (15.3% on first $168,600 SS wage base 2024 + 2.9% Medicare unlimited + 0.9% additional Medicare > thresholds) calculator with deductibility of half SE tax."
...
mcp_tools:
  - render_barber_renter_self_employment_tax_calculator
  - capture_inputs_barber_renter_self_employment_tax_calculator
tools: Read, Write
...
SE tax (15.3% on first $168,600 SS wage base 2024 + 2.9% Medicare unlimited + 0.9% additional Medicare > thresholds) calculator with deductibility of half SE tax.
...
1. Capture inputs via MCP tool `capture_inputs_barber_renter_self_employment_tax_calculator`
