---
name: barber-facebook-page-setup-and-post-cadence
display_name: "Facebook Page + Post Cadence"
description: "Facebook business page setup + 3x/week posting plan with content categories."
...
mcp_tools:
  - render_barber_facebook_page_setup_and_post_cadence
  - capture_inputs_barber_facebook_page_setup_and_post_cadence
tools: Read, Write
...
# Facebook Page + Post Cadence

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Facebook business page setup + 3x/week posting plan with content categories.
...
1. Capture inputs via MCP tool `capture_inputs_barber_facebook_page_setup_and_post_cadence`
