---
name: barber-customer-birthday-text-template
display_name: "Customer Birthday SMS Campaign Template"
description: "TCPA-compliant birthday SMS with discount offer; opt-in language; STOP keyword handling."
...
mcp_tools:
  - render_barber_customer_birthday_text_template
  - capture_inputs_barber_customer_birthday_text_template
tools: Read, Write
...
# Customer Birthday SMS Campaign Template

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

TCPA-compliant birthday SMS with discount offer; opt-in language; STOP keyword handling.
...
1. Capture inputs via MCP tool `capture_inputs_barber_customer_birthday_text_template`
