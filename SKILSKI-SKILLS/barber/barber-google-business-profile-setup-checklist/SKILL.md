---
name: barber-google-business-profile-setup-checklist
display_name: "Google Business Profile Setup Checklist"
description: "Step-by-step setup of Google Business Profile (formerly Google My Business). Verification options + photo requirements + service area."
...
mcp_tools:
  - render_barber_google_business_profile_setup_checklist
  - capture_inputs_barber_google_business_profile_setup_checklist
tools: Read, Write
...
Step-by-step setup of Google Business Profile (formerly Google My Business). Verification options + photo requirements + service area.
...
1. Capture inputs via MCP tool `capture_inputs_barber_google_business_profile_setup_checklist`
