---
name: barber-renter-aca-marketplace-enrollment-helper
display_name: "ACA Marketplace Enrollment Helper"
description: "Step-by-step ACA healthcare.gov enrollment for self-employed barber; APTC + cost-sharing reduction estimation."
...
mcp_tools:
  - render_barber_renter_aca_marketplace_enrollment_helper
  - capture_inputs_barber_renter_aca_marketplace_enrollment_helper
tools: Read, Write
...
# ACA Marketplace Enrollment Helper

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Step-by-step ACA healthcare.gov enrollment for self-employed barber; APTC + cost-sharing reduction estimation.
...
- `aca_enrollment_walkthrough.pdf`
- `plan_comparison_template.xlsx`
...
1. Capture inputs via MCP tool `capture_inputs_barber_renter_aca_marketplace_enrollment_helper`
