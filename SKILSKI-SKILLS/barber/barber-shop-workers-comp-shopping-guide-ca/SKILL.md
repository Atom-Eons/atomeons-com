---
name: barber-shop-workers-comp-shopping-guide-ca
display_name: "CA Workers Comp Shopping Guide"
description: "CA WC mandatory for 1+ W-2 employee. Shop State Compensation Insurance Fund + private carrier comparison."
...
state: CA
mcp_tools:
  - render_barber_shop_workers_comp_shopping_guide_ca
  - capture_inputs_barber_shop_workers_comp_shopping_guide_ca
tools: Read, Write
...
# CA Workers Comp Shopping Guide

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

CA WC mandatory for 1+ W-2 employee. Shop State Compensation Insurance Fund + private carrier comparison.
...
1. Capture inputs via MCP tool `capture_inputs_barber_shop_workers_comp_shopping_guide_ca`
