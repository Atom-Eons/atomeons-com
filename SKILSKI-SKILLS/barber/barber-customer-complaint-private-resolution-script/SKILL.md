---
name: barber-customer-complaint-private-resolution-script
display_name: "Customer Complaint Private Resolution Script"
description: "Phone + email script for resolving customer complaint privately before they post negative review."
...
mcp_tools:
  - render_barber_customer_complaint_private_resolution_script
  - capture_inputs_barber_customer_complaint_private_resolution_script
tools: Read, Write
...
# Customer Complaint Private Resolution Script

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Phone + email script for resolving customer complaint privately before they post negative review.
...
1. Capture inputs via MCP tool `capture_inputs_barber_customer_complaint_private_resolution_script`
