---
name: barber-saver-credit-low-income-retirement
display_name: "Saver Credit Self-Screen"
description: "Saver Credit (10/20/50% of contributions up to $2K) for low-income retirement contribution. AGI thresholds."
...
mcp_tools:
  - render_barber_saver_credit_low_income_retirement
  - capture_inputs_barber_saver_credit_low_income_retirement
tools: Read, Write
...
# Saver Credit Self-Screen

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Saver Credit (10/20/50% of contributions up to $2K) for low-income retirement contribution. AGI thresholds.
...
1. Capture inputs via MCP tool `capture_inputs_barber_saver_credit_low_income_retirement`
