---
name: barber-form-4868-extension-self-employed
display_name: "Form 4868 Personal Tax Extension"
description: "Extension of time to file 1040 for self-employed barber. Extension to file, NOT to pay."
...
mcp_tools:
  - render_barber_form_4868_extension_self_employed
  - capture_inputs_barber_form_4868_extension_self_employed
tools: Read, Write
...
# Form 4868 Personal Tax Extension

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Extension of time to file 1040 for self-employed barber. Extension to file, NOT to pay.

## Required Inputs

- `estimated_tax_owed`
- `payment_amount_with_extension`

## Outputs

- `form4868_prefilled.pdf`
...
1. Capture inputs via MCP tool `capture_inputs_barber_form_4868_extension_self_employed`
