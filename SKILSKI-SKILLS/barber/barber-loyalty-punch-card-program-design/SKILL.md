---
name: barber-loyalty-punch-card-program-design
display_name: "Loyalty Punch Card Program Design"
description: "Punch card design (10 cuts → 1 free, etc.) + tracking system + program rules."
...
mcp_tools:
  - render_barber_loyalty_punch_card_program_design
  - capture_inputs_barber_loyalty_punch_card_program_design
tools: Read, Write
...
# Loyalty Punch Card Program Design

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Punch card design (10 cuts → 1 free, etc.) + tracking system + program rules.
...
1. Capture inputs via MCP tool `capture_inputs_barber_loyalty_punch_card_program_design`
