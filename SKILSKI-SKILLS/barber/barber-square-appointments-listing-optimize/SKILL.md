---
name: barber-square-appointments-listing-optimize
display_name: "Square Appointments Optimize"
description: "Optimize Square Appointments page."
...
mcp_tools:
  - render_barber_square_appointments_listing_optimize
  - capture_inputs_barber_square_appointments_listing_optimize
tools: Read, Write
...
# Square Appointments Optimize

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Optimize Square Appointments page.
...
1. Capture inputs via MCP tool `capture_inputs_barber_square_appointments_listing_optimize`
