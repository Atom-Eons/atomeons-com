---
name: barber-renter-schedule-c-deduction-checklist
display_name: "Schedule C Deduction Checklist"
description: "Comprehensive deduction catalog for booth-renter barbers: rent, supplies, license, education, mileage, home office, health insurance, retirement."
...
mcp_tools:
  - render_barber_renter_schedule_c_deduction_checklist
  - capture_inputs_barber_renter_schedule_c_deduction_checklist
tools: Read, Write
...
Comprehensive deduction catalog for booth-renter barbers: rent, supplies, license, education, mileage, home office, health insurance, retirement.
...
- `schedule_c_checklist.pdf`
- `expense_tracking_template.xlsx`
...
1. Capture inputs via MCP tool `capture_inputs_barber_renter_schedule_c_deduction_checklist`
