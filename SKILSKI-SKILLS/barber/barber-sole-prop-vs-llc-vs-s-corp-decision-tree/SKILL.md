---
name: barber-sole-prop-vs-llc-vs-s-corp-decision-tree
display_name: "Sole Prop vs LLC vs S-Corp Decision"
description: "Entity-structure decision tree for barber: liability, tax savings, complexity, cost."
...
mcp_tools:
  - render_barber_sole_prop_vs_llc_vs_s_corp_decision_tree
  - capture_inputs_barber_sole_prop_vs_llc_vs_s_corp_decision_tree
tools: Read, Write
...
# Sole Prop vs LLC vs S-Corp Decision

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Entity-structure decision tree for barber: liability, tax savings, complexity, cost.
...
1. Capture inputs via MCP tool `capture_inputs_barber_sole_prop_vs_llc_vs_s_corp_decision_tree`
