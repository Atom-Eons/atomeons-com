---
name: barber-renter-mileage-log-template
display_name: "Mileage Log Template (Mobile + Side Gigs)"
description: "IRS-compliant mileage log for mobile barber or barber attending events; date / start / end / purpose / miles."
...
mcp_tools:
  - render_barber_renter_mileage_log_template
  - capture_inputs_barber_renter_mileage_log_template
tools: Read, Write
...
# Mileage Log Template (Mobile + Side Gigs)

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

IRS-compliant mileage log for mobile barber or barber attending events; date / start / end / purpose / miles.
...
1. Capture inputs via MCP tool `capture_inputs_barber_renter_mileage_log_template`
