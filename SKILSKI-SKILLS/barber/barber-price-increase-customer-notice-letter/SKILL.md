---
name: barber-price-increase-customer-notice-letter
display_name: "Price Increase Customer Notice Letter"
description: "Customer-facing email + posted notice for price increase. 30-day advance notice + reasoning."
...
mcp_tools:
  - render_barber_price_increase_customer_notice_letter
  - capture_inputs_barber_price_increase_customer_notice_letter
tools: Read, Write
...
# Price Increase Customer Notice Letter

Product line: SkilSki Pro SKills — Small Business — Barber.

## What It Does

Customer-facing email + posted notice for price increase. 30-day advance notice + reasoning.
...
1. Capture inputs via MCP tool `capture_inputs_barber_price_increase_customer_notice_letter`
